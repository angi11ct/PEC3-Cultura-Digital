...
![Just Dance Imagen](https://staticctf.ubisoft.com/J3yJr34U2pZ2Ieem48Dwy9uqj5PNUQTn/33HUO8fx8ne5EmdXEPjfU6/7adfbbc70bf1c23d730318e546886e29/JD26_REVEAL_ARTICLE_THUMB.jpg)
* ### La estética
...
![Familia jugando Just Dance](https://www.poluxweb.com/Polux3/images/data/videojuegos/2015/octubre/20_just_dance_2016_01.jpg)
...
![HUD](https://movilidadelectrica.com/wp-content/uploads/2021/10/HuaweiAR-HUD.jpg)
...
``` mermaid
 graph LR
    ...
    classDef fisico fill:#bbf,stroke:#333,stroke-width:2px;

    A[Mundo Físico / Realidad] -->|Captura de Datos| B{SOFTWARE}
    
    subgraph Just Dance
    B -->|Estiliza imagen| C[Bailarín de Neón]
    B -->|Procesa Movimiento| D[Puntuación/Feedback]
    end

    subgraph HUD Coches
    B -->|Geolocalización| E[Flechas GPS]
    B -->|Telemetría| F[Velocidad en Cristal]
    end

    C & D --> G((HIBRIDACIÓN))
    E & F --> G

    G --> H[Nueva Experiencia de Usuario]
